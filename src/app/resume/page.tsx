...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      fieldValue: "Cleber Gomes",
    },
    {
      fieldName: "Phone",
      fieldValue: "(+55) 99121 5633",
    },
    {
...
const education = {
  ...
  items: [
    {
      institution: "Online Programming Courses",
              ...
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map(({ company, position, duration }) => (
                      <li
                        key={company}
